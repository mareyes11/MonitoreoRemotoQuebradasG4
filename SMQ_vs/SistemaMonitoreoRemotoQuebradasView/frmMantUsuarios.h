...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// button6
			// 
			this->button6->Location = System::Drawing::Point(855, 517);
			...
			// button5
			// 
			this->button5->Location = System::Drawing::Point(702, 517);
			...
			// button4
			// 
			this->button4->Location = System::Drawing::Point(580, 517);
			...
			// button3
			// 
			this->button3->Location = System::Drawing::Point(459, 517);
			...
			this->groupBox2->Location = System::Drawing::Point(82, 226);
			...
			this->groupBox2->Size = System::Drawing::Size(924, 282);
			...
			this->dataGridView1->Location = System::Drawing::Point(9, 42);
			...
			this->dataGridView1->Size = System::Drawing::Size(876, 231);
			...
			this->groupBox1->Location = System::Drawing::Point(82, 45);
			this->groupBox1->Margin = System::Windows::Forms::Padding(4, 5, 4, 5);
			this->groupBox1->Name = L"groupBox1";
			this->groupBox1->Padding = System::Windows::Forms::Padding(4, 5, 4, 5);
			this->groupBox1->Size = System::Drawing::Size(808, 145);
			...
			// button2
			// 
			this->button2->Location = System::Drawing::Point(566, 51);
			...
			// button1
			// 
			this->button1->Location = System::Drawing::Point(687, 51);
			...
			// textBox1
			// 
			this->textBox1->Location = System::Drawing::Point(118, 54);
			...
			this->label2->Location = System::Drawing::Point(303, 58);
			...
			this->label1->Location = System::Drawing::Point(39, 58);
			...
			this->ClientSize = System::Drawing::Size(1090, 598);
...
#pragma endregion
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
		String^ apellidoBuscar = this->textBox1->Text;
		String^ codigoBuscar = this->textBox2->Text;
		UsuarioController^ objUsuarioController = gcnew UsuarioController;
		List<Usuario^>^ listaUsuarios = objUsuarioController->buscarUsuariosxApellidoxId(apellidoBuscar,codigoBuscar);
